...
async function showTasksInTable() {
    ...
    tasks.result.forEach(task => {
        ...
        <tr>
            ...
            <td>${task.status}</td>
            <td class="d-flex gap-2"><button class="btn editTask put-btn" type="button" data-id="">Editar</button><button class="btn deleteTask delete-btn" type="button" data-id="${task.id_task}">Borrar</button></td>
        </tr>
        `
    });
